  ...
  workflow_dispatch:
    inputs:
      versions:
        ...
        default: '26'
      within_max_time:
        description: 'Intra-file max pause time (seconds)'
        required: true
        default: '33'
      within_max_pauses:
      ...
      exempted_folders:
        ...
        required: false
        default: ''
      disable_intra_pauses:
        description: 'Disable intra-file pauses for exempted folders'
        required: true
        default: 'true'
        type: choice
        options:
          ...
          - 'false'
      disable_afk:
        description: 'Disable AFK pauses for exempted folders'
        required: true
        default: 'true'
        type: choice
        options:
