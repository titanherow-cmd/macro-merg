  ...
  workflow_dispatch:
    inputs:
      versions:
        ...
        default: '26'
      within_max_time:
        description: 'Max pause time in seconds (for EXEMPTED folders only, 0 to this value)'
        required: true
        default: '33'
      within_max_pauses:
        description: 'Max number of pauses (for EXEMPTED folders only, 0 to this value)'
        required: true
        default: '3'
      between_max_time:
